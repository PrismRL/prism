...
function Rectangle:intersects(other)
   ...
   return selfMin.x < otherMax.x and selfMax.x > otherMin.x and
          selfMin.y < otherMax.y and selfMax.y > otherMin.y
end
...
function Rectangle:__tostring()
   ...
   return string.format("Rectangle(x=%.2f, y=%.2f, i=%.2f, j=%.2f)", self.position.x, self.position.y, i, j)
end
